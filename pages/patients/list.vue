            ...
            <v-row justify="space-between">
              <v-col md="2" lg="2" xl="2">
                <v-btn
                  width="100%"
                  color="#7900ff"
                  class="mr-2 mb-3 boton black--text"
                  ><span class="textbtn white--text"
                    >Editar expediente</span
                  ></v-btn
                >
                <v-select
                  full-width
              ...
              <v-row justify="center mt-12 ml-16">
                <v-col class="ml-16" xs="1" sm="1" md="5" lg="10" xl="4">
                  ...
                  >
                    ...
                    <v-icon class="ml-3" size="calc(.7rem + .3vw)"
            ...
            >
              ...
              <template v-slot:[`item.gender`]>
                <v-row class="ml-n16">
                  <v-col xl="4">
                    <v-chip
                      class="chipgreen green--text"
                      style="background: #e9f7ee"
                      ><l class="chip ml-1">ASISTIÓ</l></v-chip
                    >
                  ...
                  <v-col class="ml-n6" xl="4">
                    <p class="ml-2">21/NOV/22</p></v-col
                  >
                </v-row>
              </template>
