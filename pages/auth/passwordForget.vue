          ...
          <v-col xs="1" sm="8" md="10" lg="10" xl="10">
            ...
            <v-stepper class="elevation-0" width="1000px" alt-labels v-model="e1">
              <v-stepper-header class="elevation-0">
                ...
                <v-stepper-step color="#7900ff" step="3"> Actualización </v-stepper-step>
              </v-stepper-header>
              ...
              <v-stepper-items color="red">
                <v-stepper-content step="1">
                  ...
                  <v-col xl="8">
                    <p class="code">
                    Necesitamos confirmar tu identidad, ingresa tu correo electrónico o tu teléfono,
                  ...
                  <div align="">
                    <v-col xs="11" sm="8" md="8" lg="7" xl="7">
                      ...
                      <p align="left" class="mb-1 label">
                        Ingresa tu correo electrónico o tu teléfono*
                      </p>
                      <v-text-field
                        outlined
                        class="textfield"
                ...
                <v-stepper-content step="2">
                  ...
                  <v-col xl="8">
                    <p class="code">
                    Ingresa a continuación el código de 6 caracteres que te enviamos al método de verificación que seleccionaste.
                  </p>
                  </v-col>
